...
export default function Nav(){
  return(
    <>
    <div className="addvertisement w-full  items-center justify-center">
      <span></span>
    </div>
    <div className="nav-container  bg-gray-50 p-4 flex items-center justify-between">
      <div className="brand">
        Teese<span>XR</span>
      </div>
      <div className="menu-item flex gap-5">

        <div className="seach relative group inline-group">
          <button>Accesories</button>
          {/* menu drop down */}
        <div className="fixed left-0 top-[60px] hidden group-hover:block w-screen bg-white shadow-2xl border-t z-50">
    ...
    <div className="bg-black rounded-xl text-white p-6 flex flex-col justify-between">
      ...
      <button className="mt-6 bg-white text-black py-3 rounded-lg font-medium hover:bg-gray-200 transition">
        ...
        <div className="seach relative group inline-group">
          <button>sc</button>
          {/* menu drop down */}
          <div className="absolute w-screen mt-2 hidden group-hover:block shadow-xl bg-white rounded-lg z-50">
            hllo world
          </div>
