    ...
    <div className="col-span-2">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="group cursor-pointer">
          <img
            src="https://cdn.pixabay.com/photo/2021/10/10/21/52/makeup-6698881_1280.jpg"
            alt="fashion"
            className="rounded-lg h-48 w-full object-cover group-hover:scale-105 transition duration-300"
          />
          <h4 className="mt-3 font-medium">Summer Lipstick</h4>
          <p className="text-sm text-gray-500">Up to 50% Off</p>
        </div>

        <div className="group cursor-pointer">
          <img
            src="https://cdn.pixabay.com/photo/2017/06/29/16/11/makeup-2454659_1280.jpg"
            alt="shoes"
            className="rounded-lg h-48 w-full object-cover group-hover:scale-105 transition duration-300"
          />
          <h4 className="mt-3 font-medium">Latest Cream Bar</h4>
